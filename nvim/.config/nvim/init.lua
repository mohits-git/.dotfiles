...
vim.keymap.set('n', '<leader>vd', vim.diagnostic.open_float, { desc = 'Open diagnostic Floating window info' })
...
require('lazy').setup({
  ...
  { -- UI component library for NeoVim | for Neotree
  ...
  { -- Markdown files previewer / renderer for neovim
